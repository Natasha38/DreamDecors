              ...
              <div className="tab-pane fade show active" id="jwellery" role="tabpanel" aria-labelledby="jwellery-tab">
                <div className="row">
                  ...
                  <div className="col-md-3 col-sm-6 mb-3">
                    <div className="item-product">
                      <Link to="#" className="product-thumb-link">
                        <img src="image/product-img/Natasha.png" alt="product1" className="img-fluid"/>
                      </Link>
                    </div>
                    <div className="product-info">
                      <div className="d-flex justify-content-between py-3">
                        <span className="cat-parent">NATASHA</span>
                      </div>
                      <h4 className="product-title">
                        <Link to="#">BE(CSE) 5th SEM</Link>
                      </h4>
                      <div className="product-price">
                        <ins><span className="money text-white">2110992330</span></ins>
                      </div>
              ...
              <div className="col-md-3 col-sm-6 mb-3">
                    <div className="item-product">
                      <Link to="/Products" className="product-thumb-link">
                        <img src="image/product-img/Akhya.png" alt="product1" className="img-fluid"/>
                      </Link>
                    </div>
                    <div className="product-info">
                      <div className="d-flex justify-content-between py-3">
                        <span className="cat-parent">Akhya Sinha</span>
                        
                      </div>
                      <h4 className="product-title">
                        <Link to="/Products">BE(CSE) 5th Sem</Link>
                      </h4>
                      <div className="product-price">
                        <ins><span className="money text-white">2110992275</span></ins>
                      </div>
                    </div>
                  </div>
                </div>
