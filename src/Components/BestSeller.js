                ...
                <div className="row">
                  <div className="col-md-3 col-sm-6 mb-3">
                    ...
                    <div className="product-info">
                      ...
                      <div className="product-price">
                        <ins><span className="money text-white">Rs 8000.00</span></ins>
                      </div>
                  ...
                  <div className="col-md-3 col-sm-6 mb-3">
                    ...
                    <div className="product-info">
                      ...
                      <div className="product-price">
                        <ins><span className="money text-white">Rs 14000.00</span></ins>
                      </div>
                      <div className="d-flex align-items-center justify-content-between py-1">
                        <div className="rating">
                          <i className="far fa-star"></i>
                  ...
                  <div className="col-md-3 col-sm-6 mb-3">
                    ...
                    <div className="product-info">
                      ...
                      <div className="product-price">
                        <ins><span className="money text-white">Rs 7000.00</span></ins>
                      </div>
                      <div className="d-flex align-items-center justify-content-between py-1">
                        <div className="rating">
                          <i className="far fa-star"></i>
                  ...
                  <div className="col-md-3 col-sm-6 mb-3">
                    ...
                    <div className="product-info">
                      ...
                      <div className="product-price">
                        <ins><span className="money text-white">Rs 30000.00</span></ins>
                      </div>
                      <div className="d-flex align-items-center justify-content-between py-1">
                        <div className="rating">
                          <i className="far fa-star"></i>
                ...
                <div className="row">
                  <div className="col-md-3 col-sm-6 mb-3">
                    ...
                    <div className="product-info">
                      ...
                      <div className="product-price">
                        <ins><span className="money text-white">Rs 3500.00</span></ins>
                      </div>
                      <div className="d-flex align-items-center justify-content-between py-1">
                        <div className="rating">
                          <i className="far fa-star"></i>
                  ...
                  <div className="col-md-3 col-sm-6 mb-3">
                    ...
                    <div className="product-info">
                      ...
                      <div className="product-price">
                        <ins><span className="money text-white">Rs 4000.00</span></ins>
                      </div>
                      <div className="d-flex align-items-center justify-content-between py-1">
                        <div className="rating">
                          <i className="far fa-star"></i>
                  ...
                  <div className="col-md-3 col-sm-6 mb-3">
                    ...
                    <div className="product-info">
                      ...
                      <div className="product-price">
                        <ins><span className="money text-white">Rs 4500.00</span></ins>
                      </div>
                      <div className="d-flex align-items-center justify-content-between py-1">
                        <div className="rating">
                          <i className="far fa-star"></i>
                  ...
                  <div className="col-md-3 col-sm-6 mb-3">
                    ...
                    <div className="product-info">
                      ...
                      <div className="product-price">
                        <ins><span className="money text-white">Rs 6000.00</span></ins>
                      </div>
                      <div className="d-flex align-items-center justify-content-between py-1">
                        <div className="rating">
                          <i className="far fa-star"></i>
                ...
                <div className="row">
                  ...
                  <div className="col-md-3 col-sm-6 mb-3">
                    ...
                    <div className="product-info">
                      ...
                      <div className="product-price">
                        <ins><span className="money text-white">Rs 6500.00</span></ins>
                      </div>
                      <div className="d-flex align-items-center justify-content-between py-1">
                        <div className="rating">
                          <i className="far fa-star"></i>
                  ...
                  <div className="col-md-3 col-sm-6 mb-3">
                    ...
                    <div className="product-info">
                      ...
                      <div className="product-price">
                        <ins><span className="money text-white"> Rs 5000.00</span></ins>
                      </div>
                      <div className="d-flex align-items-center justify-content-between py-1">
                        <div className="rating">
                          <i className="far fa-star"></i>
                  ...
                  <div className="col-md-3 col-sm-6 mb-3">
                    ...
                    <div className="product-info">
                      ...
                      <div className="product-price">
                        <ins><span className="money text-white">Rs 5500.00</span></ins>
                      </div>
                      <div className="d-flex align-items-center justify-content-between py-1">
                        <div className="rating">
                          <i className="far fa-star"></i>
